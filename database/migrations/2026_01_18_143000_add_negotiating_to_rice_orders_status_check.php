...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE rice_orders ADD CONSTRAINT rice_orders_status_check CHECK (status IN ('pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded', 'disputed', 'ready_for_pickup', 'picked_up', 'negotiating'))");
    }
